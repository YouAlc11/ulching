export class Topbar {
    constructor() {
        ...
        this.element.innerHTML = `<div class="container-xxl">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end p-0">
                                                    <div class="p-1">
                                                        <a class="dropdown-item py-2" href="javascript:void(0);">
                                                            <img src="resources/assets/images/brands/github.svg" class="avatar-xs"
                                                                alt="Github" />
                                                            <span class="ms-2">GitHub:
                                                                <span class="fw-medium">@reback</span></span>
                                                        </a>
                                                        <a class="dropdown-item py-2" href="javascript:void(0);">
                                                            <img src="resources/assets/images/brands/bitbucket.svg" class="avatar-xs"
                                                                alt="bitbucket" />
                                                            <span class="ms-2">Bitbucket:
                                                                <span class="fw-medium">@reback</span></span>
                                                        </a>
                                                        <a class="dropdown-item py-2" href="javascript:void(0);">
                                                            <img src="resources/assets/images/brands/dribbble.svg" class="avatar-xs"
                                                                alt="dribbble" />
                                                        ...
                                                        <a class="dropdown-item py-2" href="javascript:void(0);">
                                                            <img src="resources/assets/images/brands/dropbox.svg" class="avatar-xs"
                                                                alt="dropbox" />
                                                        ...
                                                        <a class="dropdown-item py-2" href="javascript:void(0);">
                                                            <img src="resources/assets/images/brands/slack.svg" class="avatar-xs"
                                                                alt="mail_chimp" />
                                                        ...
                                                        <a href="javascript:void(0);" class="dropdown-item py-3 border-bottom text-wrap">
                                                            <div class="d-flex">
                                                                <div class="flex-shrink-0">
                                                                    <img src="resources/assets/images/users/avatar-1.jpg"
                                                ...
                                                <a type="button" class="topbar-button" id="page-header-user-dropdown"
                                                    ...
                                                    <span class="d-flex align-items-center">
                                                        <img class="rounded-circle" width="32"
                                                            src="resources/assets/images/users/avatar-1.jpg" alt="avatar-3" />
                                                    </span>
                                                </a>
